...
/* QWERTY
 * ,------------------------------------------------.      ,------------------------------------------------.
 * |  Esc |   1  |   2  |   3  |   4  |   5  | PgUp |      | PgDwn|   6  |   7  |   8  |   9  |  0   | Del  |
 * |------+------+------+------+------+------+------|      |------+------+------+------+------+------+------|
 * |  Tab |   Q  |   W  |   E  |   R  |   T  |   -  |      |   +  |   Y  |   U  |   I  |   O  |   P  |   \  |
 * |------+------+------+------+------+------+------|      |------+------+------+------+------+------+------|
 * | Ctrl |   A  |   S  |   D  |   F  |   G  | [    |      | ]    |   H  |   J  |   K  |   L  |   ;  |   '  |
 * |------+------+------+------+------+------+------|      |------+------+------+------+------+------+------|
 * | Shift|   Z  |   X  |   C  |   V  |   B  | Home |      | End  |   N  |   M  |   ,  |   .  |   /  |VolUp |
 * |------+------+------+------+------+------+------|      |------+------+------+------+------+------+------|
 * |Lower |Lower |Super | Alt  |Enter |BkSpc |Lower |      |Lower |Space | Enter| BCK  |  FWD | Pause|VolDwn|
 * `------------------------------------------------'      `------------------------------------------------'
 */
  [_QWERTY] = KC_KEYMAP(
  //,----+----+----+----+----+----+----.    ,----+----+----+----+----+----+----.
     ESC, 1   , 2  , 3  , 4  , 5  ,PGUP,     PGDN , 6  , 7  , 8  , 9  , 0  ,DEL ,
  //|----+----+----+----+----+----+----|    |----+----+----+----+----+----+----|
     TAB, Q  , W  , E  , R   , T  ,MINS,     EQL , Y  , U  , I  , O  , P  ,BSLS,
  //|----+----+----+----+----+----+----|    |----+----+----+----+----+----+----|
     LCTL, A  , S  , D , F  , G  , LBRC,     RBRC, H  , J  , K  , L  ,SCLN,QUOT,
  //|----+----+----+----+----+----+----|    |----+----+----+----+----+----+----|
     LSFT, Z  , X  , C  , V  , B  ,HOME,     END , N  , M  ,COMM ,DOT,SLSH,VOLU,
  //|----+----+----+----+----+----+----|    |----+----+----+----+----+----+----|
     LOWR,RASE,LGUI,LALT,ENT ,BSPC,LOWR,     LOWR,SPC,ENT  ,LEFT,RGHT,MPLY,VOLD
  //`----+----+----+----+----+----+----'    `----+----+----+----+----+----+----'
  ),
 ...
 */
  ...
  //|----+----+----+----+----+----+----|    |----+----+----+----+----+----+----|
         ,    ,    , UP ,    ,HOME,    ,         ,PGUP,    , UP ,    ,    ,    ,
  //|----+----+----+----+----+----+----|    |----+----+----+----+----+----+----|
         ,    ,LEFT,DOWN,RGHT,END ,    ,         ,PGDN,LEFT,DOWN,RGHT,    ,    ,
  //|----+----+----+----+----+----+----|    |----+----+----+----+----+----+----|
         ,    ,    ,    ,    ,    ,    ,         ,    ,    ,    ,    ,    ,    ,
  //|----+----+----+----+----+----+----|    |----+----+----+----+----+----+----|
